...
namespace Arc.YTSubConverter.Formats.Ass
{
    public class AssDocument : SubtitleDocument
    {
        ...
        private void WriteHeader(TextWriter writer)
        {
            ...
            writer.WriteLine($"; Script generated by YTSubConverter-CLI {version.Major}.{version.Minor}.{version.Build}");
            writer.WriteLine("; https://github.com/louie-github/YTSubConverter-CLI");
            writer.WriteLine("; Original program (YTSubConverter) by arcusmaximus: https://github.com/arcusmaximus/YTSubConverter/");
